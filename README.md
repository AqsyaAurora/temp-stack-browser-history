...
program ini bertujuan untuk mensimulasikan prinsip kerja history browser. Program ini memiliki 3 fungsi utama, yaitu `view`, `browse` dan `back`.
...
Tugas ini dibuat oleh Aqsya Aurora <[12450121691@students.uin-suska.ac.id](124501217691@students.uin-suska.ac.id)>
